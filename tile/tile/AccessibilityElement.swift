...
//  Ported from https://github.com/rxhanson/Rectangle/blob/3b80baa1ff323e307e3cdbffd22e297ecd6b9f81/Rectangle/AccessibilityElement.swift
//
...
class AccessibilityElement {
    ...
    func withAttribute(_ attribute: CFString) -> AccessibilityElement? {
        ...
        print("Unable to obtain accessibility element")
        return nil
    }
    ...
    func isResizable() -> Bool {
        ...
        if status != .success {
            print("Unable to determine if window is resizeable. Assuming it is.")
        }
    ...
    func getIdentifier() -> Int? {
        ...
        print("Unable to obtain window id")
        return nil
    }
